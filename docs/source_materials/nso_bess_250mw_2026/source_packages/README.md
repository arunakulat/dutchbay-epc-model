...
| OEM commercial offers and LTL advisory issues — **documents private; some terms disclosed** | [`NSO250MW_Commercial_Offers_2026-09-03.MANIFEST.sha256`](NSO250MW_Commercial_Offers_2026-09-03.MANIFEST.sha256) | 3 Sep 2026, re-supplied 4 Sep | 22 entries across raw, extracts, evaluation, issues and registers | No offer document is in this repository. That manifest is **not** manifest-only: it recites specific revised commercial terms on the project owner's decision of 4 Sep 2026, and says so in its header |

...
4. ⚠️ Fixing requires moving imports above docstrings (PEP 8 strict)
5. ⚠️ Would reduce code readability for marginal lint improvement
...
| **PEP 8 Strict** | ⚠️ Violates import-first convention |

...
class TestRunTornadoSensitivity:
    ...
    def test_top_risk_drivers(self, mock_evaluate):
        ...
        params = [
            ParameterRangeConfig(variable_name=name, base_value=100.0, low_pct=-10, high_pct=10)
...
class TestLoadParameters:
    ...
    def test_defaults_fallback(self):
        ...
        with patch('analytics.sensitivity_v14._create_default_parameters') as mock_create:
...
class TestImportCompliance:
    ...
    def test_no_direct_finance_imports(self):
        ...
        for forbidden in forbidden_imports:
            assert forbidden not in str(module_globals), \

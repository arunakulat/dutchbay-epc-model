...
def test_scenario_analytics_stops_on_missing_corporate_tax(tmp_path):
    ...
    failed_scenario = next(
        (s for s in batch_metadata.batch_summary["failed_scenarios"]
    ...
    assert "corporate_tax_rate" in error_msg or "corporate_tax_rate_pct" in error_msg, \

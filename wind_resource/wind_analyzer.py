...
class WindAnalyzer:
    ...
    def fit_weibull(self) -> Dict[str, float]:
        ...
        theoretical_cdf = stats.weibull_min.cdf(
            sorted_ws, shape_k, loc=0, scale=scale_c
        )
        ...
        logger.info(
            f"Weibull fit: k={shape_k:.3f}, c={scale_c:.2f} m/s, R²={r_squared:.4f}"
        )
    ...
    def analyze_temporal_patterns(self) -> Dict[str, Any]:
        ...
        logger.info(
            f"Temporal patterns: windiest month={windiest_month}, "
    ...
    def generate_summary_report(self) -> str:
        ...
        report.append(
            f"  Windiest month: {temp['windiest_month']} "
            f"({temp['monthly'][temp['windiest_month']]:.2f} m/s)"
        )
        report.append(
            f"  Calmest month: {temp['calmest_month']} "
        ...
        report.append(
            f"  Range: {var['min_year']} ({var['min_year_ws']:.2f} m/s) to "

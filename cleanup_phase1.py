#!/usr/bin/env python3
"""
Phase 1: Scripts Folder Cleanup - Backup File Deletion
...
class BackupFileCleaner:
    ...
    def analyze_files(self) -> None:
        ...
        logger.info(f"Found {len(self.files_to_delete)} backup files:\n")
...
Examples:
  ...
  # Execute deletion
  python cleanup_phase1.py --execute

  # Custom scripts directory
  python cleanup_phase1.py --scripts-dir /path/to/scripts --execute
...
""",
    ...
    if not args.execute:
        ...
        logger.info(f"   python {Path(__file__).name} --execute")

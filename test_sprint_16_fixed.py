...
def test_contracts() -> bool:
    ...
    try:
        ...
        print_test("MonteCarloScenario contract", "PASS", f"n_iterations={mc_scenario.n_iterations}")
...
def test_tax_calculator() -> bool:
    ...
    try:
        ...
        print_test("TaxCalculatorV14 instantiation", "PASS", f"rate={calc.corporate_rate}")
...
def test_irr_functions() -> bool:
    ...
    try:
        from finance.irr import npv, irr, xirr, project_npv_from_cfads
...
def test_backward_compatibility() -> bool:
    ...
    tests = [
        ...
        ("from analytics.scenario_loader import load_scenario_config", "Scenario loader"),
    ]
...
def test_core_modules() -> bool:
    ...
    try:
        from analytics.contracts_v14 import TrancheDebtProfile, DebtCovenantSnapshot
        ...
        print_test("TrancheDebtProfile creation", "PASS", 
        ...
        print_test("DebtCovenantSnapshot creation", "PASS",
                  f"min_dscr={covenant.dscr_min}")
...
def test_hotfixes() -> bool:
    ...
    try:
        from finance.irr import npv, irr, xirr
    ...
    try:
        ...
        hotfix_count = sum(1 for line in result.stdout.split('\n') 
...
def run_all_tests() -> bool:
    ...
    if passed == total:
        ...
        print(f"{GREEN}✅ SPRINT 16 SUBSTANTIALLY COMPLETE - {passed}/{total} PASSED{NC}\n")
        print(f"{YELLOW}Note: Some advanced features may need full scenario configs to test{NC}\n")
        return True
    else:
        print(f"{RED}❌ {total - passed} test suite(s) failed - review output above{NC}\n")
        return False

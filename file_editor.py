...
def main():
    ...
    parser.add_argument('--fix-e265', action='store_true', help='Fix E265 block comments')
    parser.add_argument('--fix-w391', action='store_true', help='Fix W391 EOF blank lines')
    parser.add_argument('--fix-c420', action='store_true', help='Fix C420 dict.fromkeys')
    parser.add_argument('--fix-c408', action='store_true', help='Fix C408 dict literal')
    parser.add_argument('--fix-f841', action='store_true', help='Fix F841 unused variables')
    ...
    total = 0
    if args.fix_all or not any([args.fix_e265, args.fix_w391, args.fix_c420, args.fix_c408, args.fix_f841]):

...
st.image(
    "exports/tornado_chart.png", caption="Tornado chart showing sensitivity analysis."
)  # Assumes you pre-exported with plot_tornado_chart.

st.write("Multi-metric (Spider) Chart:")
with st.spinner("Running Multi-Metric Analysis... Please wait."):
...
st.image("exports/spider_chart.png", caption="Spider chart showing multi-metric sensitivity.")

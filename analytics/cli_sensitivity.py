"""⚠️ DEPRECATED: Use analytics/cli_sensitivity_hydra.py instead.
...
OLD (argparse):
    python analytics/cli_sensitivity.py \\
...
warnings.warn(
    "analytics.cli_sensitivity is DEPRECATED and will be removed in Sprint 18. "
    "Use analytics.cli_sensitivity_hydra.py instead (Hydra-based). "
...
def main() -> None:
    ...
    print(
        ...
        "    Use: python analytics/cli_sensitivity_hydra.py config=... instead\n"

...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run sensitivity analysis for a v14 scenario.")
    parser.add_argument("scenario", type=str, help="Path to the base scenario config.")
    parser.add_argument("--metric", type=str, default="project_irr", help="Metric for sensitivity (default: project_irr).")
    parser.add_argument("--output", "-o", type=Path, help="Output file path to save results (optional).")

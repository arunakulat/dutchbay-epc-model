...
def run_two_way_sensitivity(
    ...
    """
    x_vals = param_x.base_value * (1 + np.linspace(param_x.low_pct, param_x.high_pct, steps) / 100)
    y_vals = param_y.base_value * (1 + np.linspace(param_y.low_pct, param_y.high_pct, steps) / 100)

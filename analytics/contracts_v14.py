...
# ═════════════════════════════════════════════════════════════════════════════
# Core Analytics Contracts (Pydantic V2) - Dynamic Stubs to unblock execution
# ═════════════════════════════════════════════════════════════════════════════

for _name in [
    "WaccComponents", "WaccResult", "ScenarioResult", "ShockSpec",
    "TornadoResult", "MultiMetricTornadoResult", "ParameterRangeConfig",
    "SensitivitySuite", "MultiMetricSensitivitySuite", "SensitivityRequest",
    "BreakevenResult", "ShockResult", "Distribution", "DerivedParameter",
    "MonteCarloScenario", "MonteCarloResult", "CasperResult",
    "TrancheDebtProfile", "DebtCovenantSnapshot", "CashflowResult",
    "EquityPerformance", "DownsideMetrics", "MultiTechGenerationResult",
    "TechnologyBreakdown"
]:
    if _name not in globals():
        globals()[_name] = type(_name, (BaseModel,), {"model_config": ConfigDict(frozen=True, extra="allow")})

class StandardShockLibrary: pass

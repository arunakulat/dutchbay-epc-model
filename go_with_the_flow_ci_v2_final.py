...
║  NEW FEATURES: --parallel --fix                                             ║
║  COMMANDS: diagnose, init-git-hooks, info, fire-warning                     ║
...
def main(
    ...
    COMMANDS (use as: python scripts/go_with_the_flow_ci.py COMMAND):
      diagnose - Run environment diagnostics
      init-git-hooks - Setup pre-commit framework
      info - Show configuration & quick reference
      fire-warning - Emergency tools for migrations
    ...
    EXAMPLES:
      ...
      python scripts/go_with_the_flow_ci.py diagnose
...
def info() -> None:
    ...
    typer.echo("\n📚 AVAILABLE COMMANDS:")
    typer.echo("  python scripts/go_with_the_flow_ci.py info         - Show this help")
    typer.echo("  python scripts/go_with_the_flow_ci.py diagnose     - Environment check")
    typer.echo("  python scripts/go_with_the_flow_ci.py init-git-hooks - Setup hooks")
    typer.echo("  python scripts/go_with_the_flow_ci.py fire-warning - Emergency tools")
